...
const Newsletter = () => {
    return (
        <div className="md:w-[80%] w-full mx-auto my-20 flex md:flex-row flex-col gap-x-10 ">
            {/* left */}
            ...
            {/* right */}
            <div className="md:w-2/5 w-full p-6 px-10 justify-start  items-center flex flex-col gap-y-8 bg-gray-100">
