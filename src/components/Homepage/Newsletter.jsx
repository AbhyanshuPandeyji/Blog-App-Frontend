...
const Newsletter = () => {
    return (
        <div className=" w-full mx-auto my-20 flex md:flex-row flex-col gap-x-10 ">
            {/* left */}
            <div className="md:w-3/5 w-full p-6 justify-start flex flex-col gap-y-10 border-r-2 border-l-black">
                <h2 className="md:text-4xl text-2xl font-bold">A Simplest way to start Chaning your life and
            ...
            {/* right */}
            <div className="md:w-2/5 w-full p-6 justify-start  items-center flex flex-col md:gap-y-8 gap-y-4 bg-gray-100">
                <h2 className="md:text-4xl text-2xl font-semibold">
                    Enroll Yourself In the Journey of the High and Mighty testment of your potential
                </h2>
